...
# 로그 파일 설정
log_file="train_bal_equal_simple_$(date +%Y%m%d_%H%M%S).log"
...
# Dataset configuration - 실험 1: BAL-Equal (완전 균형 Baseline) - CoT 없는 버전
datasets="bal_equal%100"

# Output configuration
run_name="qwen2vl-bal-equal-simple-experiment-gpu01"
output_dir=./checkpoints_bal_equal_simple_experiment_gpu01
...
echo "Starting BAL-Equal Simple experiment (CoT 없는 버전) with GPU 0,1..."
