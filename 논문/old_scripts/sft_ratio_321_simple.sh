...
# 로그 파일 설정
log_file="train_c3f2w1_simple_$(date +%Y%m%d_%H%M%S).log"
...
# Dataset configuration - 실험 4: C3F2W1 (Crop heavy 비율) - CoT 없는 버전
datasets="c3f2w1%100"

# Output configuration
run_name="qwen2vl-c3f2w1-simple-experiment-gpu67"
output_dir=./checkpoints_c3f2w1_simple_experiment_gpu67
...
echo "Starting C3F2W1 Simple experiment (CoT 없는 버전) with GPU 6,7..."
