...
# 로그 파일 설정
log_file="train_no_warp_$(date +%Y%m%d_%H%M%S).log"
...
# Dataset configuration - 실험 3: No-Warp (Warp 제거 Ablation)
datasets="no_warp%100"

# Output configuration
run_name="qwen2vl-no-warp-experiment-gpu45"
output_dir=./checkpoints_no_warp_experiment_gpu45
...
echo "Starting No-Warp experiment (Warp 제거 Ablation) with GPU 4,5..."
