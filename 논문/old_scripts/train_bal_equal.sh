...
# Dataset configuration - BAL-Equal 실험 (완전 균형)
datasets="bal_equal%100"

# Output configuration
run_name="qwen2vl-bal-equal-experiment-2gpu"
output_dir=./checkpoints_bal_equal_experiment_2gpu
...
echo "Starting BAL-Equal experiment (완전 균형) with 2 GPUs..."
echo "Log file: ${log_file}"
echo "Output directory: ${output_dir}"
echo "GPUs: 4, 5 (2개)"
echo "Dataset: BAL-Equal (Crop: 2,800, Flat: 2,800, Warp: 2,800)"
echo "Total samples: 8,400"
echo "Epochs: 20 (4,200 steps per epoch)"
echo "Total steps: 84,000"
