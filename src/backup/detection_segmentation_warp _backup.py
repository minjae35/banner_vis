...
# 이미지 폴더 경로
image_dir = '/home/intern/data/image'
image_list = sorted(glob.glob(f"{image_dir}/*.jpg") + glob.glob(f"{image_dir}/*.png"))
random.seed(42)
sample_images = random.sample(image_list, min(10, len(image_list)))
